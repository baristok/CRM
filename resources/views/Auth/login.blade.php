...
<head>
    ...
    <meta content="CRM login" name="description" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">CRM</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">{{__('auth.sign_in_to_continue')}}</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form action="{{ route('login.submit') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="auth-pass-reset-basic.html" class="text-muted">{{__('auth.forgot_password')}}</a>
                                            </div>
                                        ...
                                        <div class="mt-4 text-center">
                                            <div class="signin-other-title">
                                                <h5 class="fs-13 mb-4 title">{{__('auth.sign_in_with')}}</h5>
                                            </div>
                                            <div>
