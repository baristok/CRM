    ...
    <div class="container-fluid">
      ...
      >
        <div class="col">
          <div class="card">
            <a
              class="card-body bg-danger-subtle"
            ...
            >
              <h5
                class="card-title text-uppercase fw-semibold mb-1 fs-15"
              >
                Lead Discovered
              </h5>
        ...
        <div class="col">
          <div class="card">
            <a
              class="card-body bg-success-subtle"
              data-bs-toggle="collapse"
            ...
            <div class="card mb-1">
              <div class="card-body">
                ...
                >
                  ...
                  <div class="flex-grow-1 ms-3">
                    <h6 class="fs-14 mb-1">
                      Investment Deal for Zoetic Fashion
                    </h6>
        ...
        <div class="col">
          <div class="card">
            <a
              class="card-body bg-warning-subtle"
              data-bs-toggle="collapse"
          ...
          <div class="modal-content">
            ...
            >
              <div class="modal-body">
                <div class="mb-3">
                  <label for="deatType" class="form-label"
                    >Deals Type</label
                  >
                  <select
                    class="form-select"
                ...
                <div class="mb-3">
                  <label for="dealTitle" class="form-label"
                    >Deal Title</label
                  >
                  <input
                    type="text"
                ...
                <div class="mb-3">
                  <label for="dealValue" class="form-label"
                    >Value (USD)</label
                  >
                  <input
                    type="number"
                ...
                <div class="mb-3">
                  <label for="dealOwner" class="form-label"
                    >Deals Owner</label
                  >
                  <input
                    type="text"
