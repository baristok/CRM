            ...
            <div class="tasks-board mb-3" id="kanbanboard">
                <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
                    ...
                    <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                        <div id="unassigned-task" class="tasks" data-sortable="true">
                ...
                <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
                    ...
                    <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                        <div id="todo-task" class="tasks" data-sortable="true">
                            <div class="card tasks-box">
                                <div class="card-body">
                                    <div class="d-flex mb-2">
                                        <div class="flex-grow-1">
                ...
                <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
                    ...
                    <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                        <div id="inprogress-task" class="tasks" data-sortable="true">
                            <div class="card tasks-box">
                                <div class="card-body">
                                    <div class="d-flex mb-2">
                ...
                <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
                    ...
                    <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                        <div id="reviews-task" class="tasks" data-sortable="true">
                            <div class="card tasks-box">
                                <div class="card-body">
                                    <div class="d-flex mb-2">
                                        <a href="javascript:void(0)"
                ...
                <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
                    ...
                    <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                        <div id="completed-task" class="tasks" data-sortable="true">
                            <div class="card tasks-box">
                                <div class="card-body">
                                    <div class="d-flex mb-2">
                                        <h6 class="fs-15 mb-0 flex-grow-1 text-truncate task-title"><a
                ...
                <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
                    ...
                    <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                        <div id="new-task" class="tasks" data-sortable="true">
                            <div class="card tasks-box">
                                <div class="card-body">
                                    <div class="d-flex mb-2">
                                        <a href="javascript:void(0)"
