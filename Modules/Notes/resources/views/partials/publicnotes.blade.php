        ...
        <div class="card-body">
            <div class="row g-2">
                ...
                <div class="col-auto ms-sm-auto">
                    <div class="avatar-group" id="public-newMembar">
                        ...
                        <a href="#public-addmemberModal" data-bs-toggle="modal" class="avatar-group-item">
                            <div class="avatar-xs">
...
<div class="tasks-board mb-3" id="public-kanbanboard">
    <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
        ...
        <div data-simplebar class="tasks-wrapper px-3 mx-n3">
            <div id="public-todo-task" class="tasks" data-sortable="true">
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            <div class="flex-grow-1">
                                <h6 class="fs-15 mb-0 text-truncate task-title"><a href="apps-tasks-details.html"
                                        class="d-block">Admin Layout Design</a>
                                </h6>
                            </div>
                            <div class="flex-shrink-0">
                ...
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-shrink-0">
                                <a href="javascript:void(0);" class="text-muted" id="public-dropdownMenuLink4"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-fill"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="public-dropdownMenuLink4">
                                    <li><a class="dropdown-item" href="apps-tasks-details.html"><i
                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
        ...
        <div class="my-3">
            <button class="btn btn-soft-primary w-100" data-bs-toggle="modal" data-bs-target="#public-creatertaskModal">Add
                More</button>
        </div>
    </div>
    <!--end tasks-list-->
    <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
        ...
        <div data-simplebar class="tasks-wrapper px-3 mx-n3">
            <div id="public-unassigned-task" class="tasks" data-sortable="true">
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            ...
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="text-muted" id="public-dropdownMenuLink1"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-fill"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="public-dropdownMenuLink1">
                                    <li><a class="dropdown-item" href="apps-tasks-details.html"><i
                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
                ...
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            <div class="flex-grow-1">
                                <h6 class="fs-15 mb-0 text-truncate task-title"><a href="apps-tasks-details.html"
                                        class="d-block">Velzon - Admin Layout
                                        Design</a></h6>
                            </div>
                            <div class="flex-shrink-0">
                                <a href="javascript:void(0);" class="text-muted" id="public-dropdownMenuLink12"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-fill"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="public-dropdownMenuLink12">
                                    <li><a class="dropdown-item" href="apps-tasks-details.html"><i
                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
    ...
    <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
        ...
        <div data-simplebar class="tasks-wrapper px-3 mx-n3">
            <div id="public-inprogress-task" class="tasks" data-sortable="true">
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            <a href="javascript:void(0)" class="text-muted fw-medium fs-14 flex-grow-1">#VL2457</a>
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="text-muted" id="public-dropdownMenuLink5"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-fill"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="public-dropdownMenuLink5">
                                    <li><a class="dropdown-item" href="apps-tasks-details.html"><i
                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
                ...
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            ...
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="text-muted" id="public-dropdownMenuLink6"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-fill"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="public-dropdownMenuLink6">
                                    <li><a class="dropdown-item" href="apps-tasks-details.html"><i
                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
    ...
    <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
        ...
        <div data-simplebar class="tasks-wrapper px-3 mx-n3">
            <div id="public-reviews-task" class="tasks" data-sortable="true">
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            <a href="javascript:void(0)" class="text-muted fw-medium fs-14 flex-grow-1">#VL2453</a>
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="text-muted" id="public-dropdownMenuLink7"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-fill"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="public-dropdownMenuLink7">
                                    <li><a class="dropdown-item" href="apps-tasks-details.html"><i
                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
                ...
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            ...
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="text-muted" id="public-dropdownMenuLink8"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-fill"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="public-dropdownMenuLink8">
                                    <li><a class="dropdown-item" href="apps-tasks-details.html"><i
                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
                ...
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            ...
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="text-muted" id="public-dropdownMenuLink9"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-fill"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="public-dropdownMenuLink9">
                                    <li><a class="dropdown-item" href="apps-tasks-details.html"><i
                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
    ...
    <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
        ...
        <div data-simplebar class="tasks-wrapper px-3 mx-n3">
            <div id="public-completed-task" class="tasks" data-sortable="true">
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            <h6 class="fs-15 mb-0 flex-grow-1 text-truncate task-title"><a
                                    ...
                                    UI</a></h6>
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="text-muted" id="public-dropdownMenuLink10"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-fill"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="public-dropdownMenuLink10">
                                    <li><a class="dropdown-item" href="apps-tasks-details.html"><i
                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
        ...
        <div class="my-3">
            <button class="btn btn-soft-primary w-100" data-bs-toggle="modal"
                data-bs-target="#public-creatertaskModal">Add More</button>
        </div>
    </div>
    <!--end tasks-list-->
    <div class="tasks-list" data-sortable-group="kanban" data-sortable-animation="150">
        ...
        <div data-simplebar class="tasks-wrapper px-3 mx-n3">
            <div id="public-new-task" class="tasks" data-sortable="true">
                <div class="card tasks-box">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            <a href="javascript:void(0)" class="text-muted fw-medium fs-14 flex-grow-1">#VL5287</a>
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="text-muted" id="public-dropdownMenuLink2"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i
                                        class="ri-more-fill"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="public-dropdownMenuLink2">
                                    <li><a class="dropdown-item" href="apps-tasks-details.html"><i
                                                class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
...
<div class="modal fade" id="public-addmemberModal" tabindex="-1" aria-labelledby="public-addmemberModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content border-0">
            <div class="modal-header p-3 bg-primary-subtle">
                <h5 class="modal-title" id="public-addmemberModalLabel">Add Member</h5>
                <button type="button" class="btn-close" id="public-btn-close-member" data-bs-dismiss="modal"
                ...
                <form>
                    <div class="row g-3">
                        <div class="col-lg-12">
                            ...
                            <input type="number" class="form-control" id="public-submissionidInput"
                                placeholder="Submission ID">
                        </div>
                        <!--end col-->
                        <div class="col-lg-12">
                            <label for="profileimgInput" class="form-label">Profile Images</label>
                            <input class="form-control" type="file" id="public-profileimgInput">
                        </div>
                        <!--end col-->
                        <div class="col-lg-6">
                            <label for="firstnameInput" class="form-label">First Name</label>
                            <input type="text" class="form-control" id="public-firstnameInput"
                                placeholder="Enter firstname">
                        </div>
                        <!--end col-->
                        <div class="col-lg-6">
                            <label for="lastnameInput" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="public-lastnameInput"
                                placeholder="Enter lastname">
                        </div>
                        <!--end col-->
                        <div class="col-lg-12">
                            <label for="designationInput" class="form-label">Designation</label>
                            <input type="text" class="form-control" id="public-designationInput"
                                placeholder="Designation">
                        </div>
                        <!--end col-->
                        <div class="col-lg-12">
                            <label for="titleInput" class="form-label">Title</label>
                            <input type="text" class="form-control" id="public-titleInput" placeholder="Title">
                        </div>
                        <!--end col-->
                        <div class="col-lg-6">
                            <label for="numberInput" class="form-label">Phone Number</label>
                            <input type="text" class="form-control" id="public-numberInput"
                                placeholder="Phone number">
                        </div>
                        <!--end col-->
                        <div class="col-lg-6">
                            <label for="joiningdateInput" class="form-label">Joining Date</label>
                            <input type="text" class="form-control" id="public-joiningdateInput"
                                data-provider="flatpickr" placeholder="Select date">
                        </div>
                        <!--end col-->
                        <div class="col-lg-12">
                            <label for="emailInput" class="form-label">Email ID</label>
                            <input type="email" class="form-control" id="public-emailInput" placeholder="Email">
                        </div>
                        <!--end col-->
                    </div>
                    <!--end row-->
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="public-addMember">Add Member</button>
            </div>
        </div>
    </div>
</div>
                ...
                <form action="#">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control" id="public-boardName"
                        ...
                        <div class="mt-4">
                            <div class="hstack gap-2 justify-content-end">
                                ...
                                <button type="button" class="btn btn-primary" id="public-addNewBoard">Add
                                    Board</button>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="public-creatertaskModal" tabindex="-1" aria-labelledby="public-creatertaskModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0">
            <div class="modal-header p-3 bg-primary-subtle">
                <h5 class="modal-title" id="public-creatertaskModalLabel">Create New Task</h5>
                ...
                <form action="#">
                    <div class="row g-3">
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control" id="public-projectName"
                                placeholder="Enter project name">
                        </div>
                        <!--end col-->
                        <div class="col-lg-12">
                            <label for="sub-tasks" class="form-label">Task Title</label>
                            <input type="text" class="form-control" id="public-sub-tasks" placeholder="Task title">
                        </div>
                        <!--end col-->
                        <div class="col-lg-12">
                            <label for="task-description" class="form-label">Task Description</label>
                            <textarea class="form-control" id="public-task-description" rows="3" placeholder="Task description"></textarea>
                        </div>
                        <!--end col-->
                        <div class="col-lg-12">
                            <label for="formFile" class="form-label">Tasks Images</label>
                            <input class="form-control" type="file" id="public-formFile">
                        </div>
                        <!--end col-->
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="public-due-date" data-provider="flatpickr"
                                placeholder="Select date">
                        </div>
                        <!--end col-->
                        <div class="col-lg-4">
                            <label for="categories" class="form-label">Tags</label>
                            <input type="text" class="form-control" id="public-categories" placeholder="Enter tag">
                        </div>
                        <!--end col-->
                        <div class="col-lg-4">
                            <label for="tasks-progress" class="form-label">Tasks Progress</label>
                            <input type="text" class="form-control" maxlength="3" id="public-tasks-progress"
...
<div class="modal fade zoomIn" id="public-deleteRecordModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                    ...
                    <button type="button" class="btn w-sm btn-danger" id="public-delete-record">Yes, Delete
                        It!</button>
                </div>
            </div>
        </div>
